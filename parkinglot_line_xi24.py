...
class Parking(object):
  ...
  def configureDataset(self):
      ...
      if not os.path.exists(self.output_dir + "/f1" +'/images2'):
          os.makedirs(self.output_dir + "/f1" +'/images2')
      if not os.path.exists(self.output_dir + "/f2" +'/images2'):
          os.makedirs(self.output_dir + "/f2" +'/images2')
      if not os.path.exists(self.output_dir + "/f3" +'/images2'):
          os.makedirs(self.output_dir + "/f3" +'/images2')
      if not os.path.exists(self.output_dir+"/f4" +'/images2'):
          os.makedirs(self.output_dir + "/f4" +'/images2')
      if not os.path.exists(self.output_dir+"/f5" +'/images2'):
          os.makedirs(self.output_dir + "/f5" +'/images2')
      if not os.path.exists(self.output_dir+"/f6" +'/images2'):
          os.makedirs(self.output_dir + "/f6" +'/images2')
      if not os.path.exists(self.output_dir+"/f7" +'/images2'):
          os.makedirs(self.output_dir + "/f7" +'/images2')
...
###########################################################################
  ...
  def RecoveryModel(self):
  	...
  	bpy.ops.wm.save_as_mainfile(filepath="/home/cui/blender/blender/xi2017.8.23_30.blend") #保存模型
  	bpy.ops.wm.open_mainfile(filepath="/home/cui/blender/blender/xi2017.8.23_30.blend")##加载模型
  ...
  def saveLocalImage(self, i, keyframe):
    if keyframe == 1.0:
       output_filepath = self.output_dir + "/f1" +'/images/' + str(i + 1) + '.png'
       depth_path ="/f1" +'/images2/'+str(i + 1)+'.png'
    elif keyframe == 2.0:
       output_filepath = self.output_dir + "/f2" +'/images/' + str(i + 1) + '.png'
       depth_path = "/f2" + '/images2/'+str(i + 1)+'.png'
    elif keyframe == 3.0:
       output_filepath = self.output_dir + "/f3" +'/images/' + str(i + 1) + '.png'
       depth_path ="/f3" +'/images2/'+str(i + 1)+'.png'
    elif keyframe == 4.0:
       output_filepath = self.output_dir + "/f4" +'/images/' + str(i + 1) + '.png'
       depth_path ="/f4" +'/images2/'+str(i + 1)+'.png'
    elif keyframe == 5.0:
       output_filepath = self.output_dir + "/f5" +'/images/' + str(i + 1) + '.png'
       depth_path ="/f5" +'/images2/'+str(i + 1)+'.png'
    elif keyframe == 6.0:
       output_filepath = self.output_dir + "/f6" +'/images/' + str(i + 1) + '.png'
       depth_path ="/f6" +'/images2/'+str(i + 1)+'.png'
    elif keyframe == 7.0:
       output_filepath = self.output_dir + "/f7" +'/images/' + str(i + 1) + '.png'
       depth_path ="/f7" +'/images2/'+str(i + 1)+'.png'
    #self.nodes['File Output'].file_slots[0].path = depth_path
...
if __name__=="__main__":
    ...
    parking = Parking('/home/cui/blender/blender/data6')
    parking.startRenderingIteration(1)
    sampleCarLocations(self,2)
